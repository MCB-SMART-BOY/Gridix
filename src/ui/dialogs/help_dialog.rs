...
impl HelpDialog {
    ...
    fn show_content(ui: &mut egui::Ui) {
        ...
        ui.label(
            RichText::new("   按 Ctrl+N 创建新连接，支持 MySQL、PostgreSQL、SQLite").color(text),
        );
        ui.add_space(4.0);
        ...
        ui.label(
            RichText::new("   按 Ctrl+J 打开编辑器，输入 SQL 后按 Ctrl+Enter 执行").color(text),
        );
        ...
        ui.label(
            RichText::new("Gridix 的各个区域之间可以用 hjkl 无缝切换：")
                .color(muted)
                .italics(),
        );
        ui.add_space(8.0);
        ...
        ui.label(
            RichText::new("表格采用模态编辑，类似 Helix/Vim 编辑器，分为三种模式：")
                .color(muted)
                .italics(),
        );
        ui.add_space(8.0);
        ...
        ui.label(
            RichText::new("编辑器同样支持 Normal/Insert 双模式，左下角显示当前模式。")
                .color(muted)
                .italics(),
        );
        ui.add_space(8.0);
        ...
        ui.label(
            RichText::new("侧边栏分为多个面板：连接、数据库、表、筛选、触发器、存储过程。")
                .color(muted)
                .italics(),
        );
        ui.add_space(8.0);
        ...
        ui.label(
            RichText::new("在表格中按 / 或 f 快速添加筛选条件。支持以下操作符：")
                .color(muted)
                .italics(),
        );
        ui.add_space(8.0);
        ...
        ui.horizontal(|ui| {
            ...
            ui.hyperlink_to(
                RichText::new("github.com/pzyyll/Gridix")
                    .small()
                    .color(accent),
