...
pub const SCOPED_COMMANDS: &[ScopedCommand] = &[
    ...
    ScopedCommand {
        id: "dialog.welcome_setup.focus_next",
        description: "引导对话框切到下一个动作",
        category: "欢迎引导",
        default_bindings: &[bind(KeyCode::Tab, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "dialog.welcome_setup.focus_prev",
        description: "引导对话框切到上一个动作",
        category: "欢迎引导",
        default_bindings: &[bind(KeyCode::Tab, KeyModifiers::SHIFT)],
    },
    ScopedCommand {
        id: "dialog.welcome_setup.recheck_environment",
        description: "重新检测数据库环境",
        category: "欢迎引导",
        default_bindings: &[bind(KeyCode::Num1, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "dialog.welcome_setup.open_connection",
        description: "打开新建连接",
        category: "欢迎引导",
        default_bindings: &[bind(KeyCode::Num2, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "dialog.welcome_setup.initialize_database",
        description: "初始化数据库",
        category: "欢迎引导",
        default_bindings: &[bind(KeyCode::Num3, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "dialog.welcome_setup.create_user",
        description: "创建数据库用户",
        category: "欢迎引导",
        default_bindings: &[bind(KeyCode::Num4, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "dialog.welcome_setup.run_first_query",
        description: "执行首条查询",
        category: "欢迎引导",
        default_bindings: &[bind(KeyCode::Num5, KeyModifiers::NONE)],
    },
    ScopedCommand {
    ...
    ScopedCommand {
        ...
        category: "ER 图",
        default_bindings: &[bind(KeyCode::L, KeyModifiers::SHIFT)],
    },
    ScopedCommand {
    ...
    ScopedCommand {
        id: "er_diagram.prev_table",
        description: "ER 图上一张表",
        category: "ER 图",
        default_bindings: &[
            bind(KeyCode::K, KeyModifiers::NONE),
            bind(KeyCode::ArrowUp, KeyModifiers::NONE),
    ...
    ScopedCommand {
        id: "er_diagram.next_table",
        description: "ER 图下一张表",
        category: "ER 图",
        default_bindings: &[
            bind(KeyCode::J, KeyModifiers::NONE),
            bind(KeyCode::ArrowDown, KeyModifiers::NONE),
    ...
    ScopedCommand {
        id: "er_diagram.prev_related",
        description: "ER 图上一张关联表",
        category: "ER 图",
        default_bindings: &[bind(KeyCode::K, KeyModifiers::SHIFT)],
    },
    ScopedCommand {
        id: "er_diagram.next_related",
        description: "ER 图下一张关联表",
        category: "ER 图",
        default_bindings: &[bind(KeyCode::J, KeyModifiers::SHIFT)],
    },
    ScopedCommand {
    ...
    ScopedCommand {
        ...
        description: "ER 图几何邻接向下",
        category: "ER 图",
        default_bindings: &[bind(KeyCode::ArrowDown, KeyModifiers::SHIFT)],
    },
    ScopedCommand {
        id: "er_diagram.geometry_up",
        description: "ER 图几何邻接向上",
        category: "ER 图",
        default_bindings: &[bind(KeyCode::ArrowUp, KeyModifiers::SHIFT)],
    },
    ScopedCommand {
    ...
    ScopedCommand {
        ...
        description: "ER 图关闭",
        category: "ER 图",
        default_bindings: &[bind(KeyCode::Q, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "er_diagram.viewport_mode",
        description: "ER 图切换视口模式",
        category: "ER 图",
        default_bindings: &[bind(KeyCode::V, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "er_diagram.viewport.exit",
        description: "ER 图退出视口模式",
        category: "ER 图视口",
        default_bindings: &[bind(KeyCode::Escape, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "er_diagram.viewport.pan_left",
        description: "ER 图视口向左平移",
        category: "ER 图视口",
        default_bindings: &[bind(KeyCode::H, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "er_diagram.viewport.pan_down",
        description: "ER 图视口向下平移",
        category: "ER 图视口",
        default_bindings: &[bind(KeyCode::J, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "er_diagram.viewport.pan_up",
        description: "ER 图视口向上平移",
        category: "ER 图视口",
        default_bindings: &[bind(KeyCode::K, KeyModifiers::NONE)],
    },
    ScopedCommand {
        id: "er_diagram.viewport.pan_right",
        description: "ER 图视口向右平移",
        category: "ER 图视口",
