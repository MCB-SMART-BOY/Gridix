...
pub struct UiState {
    ...
    pub(crate) last_non_er_workspace_focus: FocusArea,
    ...
    pub(crate) toolbar_actions_menu_state: ToolbarMenuDialogState,
    pub(crate) toolbar_create_menu_state: ToolbarMenuDialogState,
    pub(crate) toolbar_theme_dialog_state: ToolbarThemeDialogState,
    pub(crate) help_state: HelpState,
    pub(crate) create_user_dialog_state: CreateUserDialogState,
    ...
    pub(crate) pending_delete_target: Option<crate::ui::SidebarDeleteTarget>,
