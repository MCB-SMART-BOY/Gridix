...
[![Version](https://img.shields.io/badge/version-3.7.0-blue.svg)](https://github.com/MCB-SMART-BOY/Gridix/releases)
...
# pinned release
nix run github:MCB-SMART-BOY/Gridix/v3.7.0
nix profile install github:MCB-SMART-BOY/Gridix/v3.7.0
